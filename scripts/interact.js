...
const myContractERC20 = new ethers.Contract(
...
async function main() {
  ...
  console.log(
    "Balance of SaintEmilion : ",
    JSON.stringify(myBalanceSaintEmilion)
  );
  ...
  console.log(
    `You need ${montantPourTousAcheter} SPLIT to buy all Saint-Emilion`
  );
